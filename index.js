...
window.addEventListener("DOMContentLoaded", function () {
    let displayMenu = productList.map(function (item) {
        ...
        <div class="card-details">
            <h3 class="${item.name}">Men Navy Blue Solid Sweatshirt</h3>
            <h4 class="${item.brand}">United Colors of Benetton</h4>
            <h5 class="${item.price}">2599</h5>
        </div>
    </div>`;
    });
